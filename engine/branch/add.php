...
$(document).ready(function(){
	...
	$('nav li.branch').addClass('nav-active');
});
</script>
...
<header class="page-header"><h2><i class="fa fa-building"></i> Formulir Kantor Cabang</h2>
<div class="right-wrapper pull-right">
	<ol class="breadcrumbs">
		<li><a href="<?php echo c_LANDING;?>"><i class="fa fa-home"></i></a></li>
		<li><a href="./front"><span>Branch</span></a></li>
		<li><span>Add</span></li>
	</ol>
...
<div class="row">
<section class="panel">
	<a href="./front" class="btn btn-default"><i class="fa fa-arrow-left"></i> Kembali ke Daftar Kantor Cabang</a>
</section>
</div>
			...
			<div class="panel-body">
				<div class="form-group">
					<label class="col-md-3 control-label" for="name">
						Kantor Cabang 
						<span class="btn btn-xs" style="border-color: #eaeaea;" rel="tooltip" data-placement="bottom" data-original-title="Nama Kantor Cabang / Kantor Cabang Pembantu"><a href="#" class="fa fa-question"></a></span>
					</label>
					<div class="col-md-9">
						<input name="name" id="name" type="text" placeholder="cth: Cab. Pontianak" class="form-control">
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-3 control-label">
						Tanggal Berdiri
						<span class="btn btn-xs" style="border-color: #eaeaea;" rel="tooltip" data-placement="bottom" data-original-title="Tanggal Berdiri Kantor Cabang / Kantor Cabang Pembantu"><a href="#" class="fa fa-question"></a></span>
					</label>
					<div class="col-md-9">
				...
				<div class="form-group">
					<label class="col-md-3 control-label" for="keterangan">Alamat</label>
					<div class="col-md-9">
